...
--
-- Table structure for table `finalclass8term1`
--

DROP TABLE IF EXISTS `finalclass8term1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `finalclass8term1` (
  `grno` int(7) NOT NULL,
...
--
-- Dumping data for table `finalclass8term1`
--

LOCK TABLES `finalclass8term1` WRITE;
/*!40000 ALTER TABLE `finalclass8term1` DISABLE KEYS */;
/*!40000 ALTER TABLE `finalclass8term1` ENABLE KEYS */;
UNLOCK TABLES;
