...
--
-- Table structure for table `finalclass8term2`
--

DROP TABLE IF EXISTS `finalclass8term2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `finalclass8term2` (
  `grno` int(7) NOT NULL,
...
--
-- Dumping data for table `finalclass8term2`
--

LOCK TABLES `finalclass8term2` WRITE;
/*!40000 ALTER TABLE `finalclass8term2` DISABLE KEYS */;
INSERT INTO `finalclass8term2` VALUES (254,'a ',3,2,2,9,9,9,9,9,9,9,' a ',' a ',' a ',' a ',54,9,1,3,'2 ','sd ',' d ','8');
/*!40000 ALTER TABLE `finalclass8term2` ENABLE KEYS */;
UNLOCK TABLES;
