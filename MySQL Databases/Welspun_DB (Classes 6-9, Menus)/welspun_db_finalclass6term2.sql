...
--
-- Table structure for table `finalclass6term2`
--

DROP TABLE IF EXISTS `finalclass6term2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `finalclass6term2` (
  `grno` int(7) NOT NULL,
...
--
-- Dumping data for table `finalclass6term2`
--

LOCK TABLES `finalclass6term2` WRITE;
/*!40000 ALTER TABLE `finalclass6term2` DISABLE KEYS */;
INSERT INTO `finalclass6term2` VALUES (23133,'A',21,NULL,NULL,54.041000000000004,8.041,8.041,8.041,8.042,8.042,8.041,'b','b','b','b',94.248,15.708,NULL,NULL,'null','null','null','6');
/*!40000 ALTER TABLE `finalclass6term2` ENABLE KEYS */;
UNLOCK TABLES;
